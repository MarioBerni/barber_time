...
/// 
/// Esta clase contiene los métodos de construcción para diferentes tipos de gradientes
...
class GradientBuilders {
  ...
  static Widget buildProfessionalVerticalGradient({
    ...
    final Color topColor = accentColor.withAlpha((opacity * 0.3 * intensity * 255).round());
    final Color bottomColor = baseColor.withAlpha((opacity * intensity * 255).round());
  ...
  static Widget buildCornerLightGradient({
    ...
    final Color lightColor = accentColor.withAlpha((opacity * 0.4 * intensity * 255).round());
    final Color darkColor = baseColor.withAlpha((opacity * intensity * 255).round());
  ...
  static Widget buildSoftVignetteGradient({
    ...
    final Color darkColor = baseColor.withAlpha((opacity * intensity * 255).round());
    final Color accentGlow = accentColor.withAlpha((opacity * 0.2 * intensity * 255).round());
  ...
  static Widget buildRadialGradient({
    ...
    final Color centerColor = accentColor.withAlpha((opacity * 0.3 * intensity * 255).round());
    final Color edgeColor = baseColor.withAlpha((opacity * intensity * 255).round());
