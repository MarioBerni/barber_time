...
/// Clase de ayuda para los estilos y configuraciones visuales
/// del StylizedButton
    ...
    switch (type) {
      case StylizedButtonType.primary:
        return ElevatedButton.styleFrom(
          ...
          backgroundColor:
              context.mediumGold, // Usa el dorado del tema centralizado
          foregroundColor: Colors.white,
          elevation: isPressed ? 0 : 2,
          shadowColor: context.mediumGold.withAlpha(
            (0.3 * 255).round(),
