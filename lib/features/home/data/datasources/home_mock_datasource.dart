  ...
  Future<List<SpecialOffer>> getSpecialOffers() async {
    ...
    return [
      ...
      const SpecialOffer(
        ...
        discount: '15%',
        imageUrl: 'https://images.unsplash.com/photo-1628890891274-89aa45592e85',
        promoCode: 'FAMILIA15',
      ),
    ];
  }
  ...
  Future<List<Salon>> getTopRatedSalons() async {
    ...
    return [
      ...
      const Salon(
        ...
        imageUrl: 'https://images.unsplash.com/photo-1622288432207-ee648dfcc28d',
        rating: 4.6,
        reviewCount: 76,
        price: '\$120',
        isFavorite: true,
  ...
  Future<List<Salon>> getRecommendedSalons() async {
    ...
    return [
      ...
      const Salon(
        ...
        imageUrl: 'https://images.unsplash.com/photo-1534297635766-a262cdcb8ee4',
        rating: 4.4,
        reviewCount: 53,
        price: '\$100',
      ),
